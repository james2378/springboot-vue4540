<template>
	<div>
		...
		<b-form-group v-if="$check_register_field('add','id','/ordinary_users/view')" id="input-group-2" label="身份证" label-for="input-2">
			<b-form-input id="input-2" v-model="form['id']" type="text" placeholder="身份证" trim></b-form-input>
		</b-form-group>
	</div>
</template>
